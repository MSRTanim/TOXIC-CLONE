...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mTOXIC_CYBER\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : TOXIC CYBER SECURITY
\033[1;92m☞ WhatsApp   : +8801885686368
\033[1;95m☞ YouTube    : https://www.youtube.com/channel/UC9mgD2x-Bm2A8YVyTxaIKgw
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.youtube.com/channel/UC9mgD2x-Bm2A8YVyTxaIKgw')
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update TOXIC_CYBER Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' TOXIC_CYBER WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/TOXIC-CLONE')
	    os.system('cd $HOME && git clone https://github.com/MSRTanim/TOXIC-CLONE.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num +8801580533739✓')
	    psb('WellCome To TOXIC_CYBER')
	    psb('Congratulations TOXIC_CYBER Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ TOXIC✓')
	    psb('🔓Password ☆ TOXIC✓')
	    psb('Subscribe My Youtube Channel TOXIC GAME ZONE✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/TOXIC-CYBER && python2 TOXIC.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/BaS7taYKA11ExP5o7YoMiN')
	    menu()
	elif bm =='4':
